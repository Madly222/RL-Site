        ...
        <div className="container">
          <div className="contact-page__grid">
            <div className="contact-page__form-wrap" id="contact-form">
              <h2 className="contact-page__form-title">{t('contact.formTitle')}</h2>
            ...
            <div className="contact-page__info">
              <h2 className="contact-page__info-title">{t('contact.infoTitle')}</h2>
              ...
              <div className="contact-page__map">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2719.5!2d28.8575!3d47.0105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDfCsDAwJzM3LjgiTiAyOMKwNTEnMjcuMCJF!5e0!3m2!1sen!2s!4v1234567890"
                  width="100%"
                  height="280"
