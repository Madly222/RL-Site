      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div className="footer__col">
            <EditableText value={t('footer.servicesTitle')} tag="h4" className="footer__heading" onSave={s('footer.servicesTitle')} />
          ...
          <div className="footer__col">
            <EditableText value={t('footer.contactsTitle')} tag="h4" className="footer__heading" onSave={s('footer.contactsTitle')} />
